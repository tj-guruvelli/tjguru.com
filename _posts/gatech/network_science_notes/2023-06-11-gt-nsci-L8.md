...
_typo: intelligence community marked as Light and Light community marked as Intelligence._
...
_typo: The bottom right should be d and not b_
...
_Figure 9.22 from Network Science by Albert-László Barabási_
...
_Figure 9.23 from Network Science by Albert-László Barabási_
...
_Figure 9.24 from Network Science by Albert-László Barabási_
...
_Figure 9.25 from Network Science by Albert-László Barabási_
...
_Figure 9.29 from Network Science by Albert-László Barabási_
...
_Figure 9.26 from Network Science by Albert-László Barabási_
...
_Example: Confusion matrix with two partitions._
...
_Figure 9.27 from Network Science by Albert-László Barabási_
...
_Figure 9.28 from Network Science by Albert-László Barabási_
...
_Figure 1 [Dynamic Community Detection](https://doi.org/10.1007/978-1-4614-6170-8_383).by Cazabet R., Amblard F._
...
_Figure 2 [Dynamic Community Detection](https://doi.org/10.1007/978-1-4614-6170-8_383).by Cazabet R., Amblard F._
...
_Figure 3 [Dynamic Community Detection](https://doi.org/10.1007/978-1-4614-6170-8_383).by Cazabet R., Amblard F._
...
_Figure 4 [Dynamic Community Detection](https://doi.org/10.1007/978-1-4614-6170-8_383).by Cazabet R., Amblard F._
...
_Figure from [Worked Example: Centrality and Community Structure of US Air Transportation Network](https://dshizuka.github.io/networkanalysis/example_usairports.html). by Dai Shizuka_
...
_Figure 3: Cartographic representation of the metabolic network of E. coli. from [Functional cartography of complex metabolic networks](https://www.nature.com/articles/nature03288). by Guimerà, R., Nunes Amaral, L._
...
_Figure from "[δ-MAPS: from spatio-temporal data to a weighted and lagged network between functional domains](https://link.springer.com/article/10.1007/s41109-018-0078-z)" by Fountalis, I., Dovrolis, C., Bracco, A. et al., 2018_
