...
_Image source: http://www.old-ib.bioninja.com.au/options/option-g-ecology-and-conser/g5-population-ecology.html_
...
_Image source: Kolaczyk, Eric D. Statistical Analysis of Network Data: Methods and Models (2009) Springer Science+Business Media LLC._
...
_Source: “Statistical analysis of network data” by E.D.Kolaczyk. http://math.bu.edu/ness12/ness2012-shortcourse-kolaczyk.pdf_
...
- $𝑍^{(3)}_{𝑖,𝑗}=1 \text{ if ($practice*𝑖=practice*𝑗$) and 0 otherwise}$
- $𝑍^{(4)}_{𝑖,𝑗}=1 \text{ if ($gender*𝑖=gender*𝑗$) and 0 otherwise}$
- $𝑍^{(5)}_{𝑖,𝑗}=1 \text{ if ($office*𝑖=office*𝑗$) and 0 otherwise}$
...
_Image source: "The power of the Benjamini-Hochberg procedure", by W. van Loon, http://www.math.leidenuniv.nl/scripties/MastervanLoon.pdf_
